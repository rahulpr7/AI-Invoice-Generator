...
// For computing subtotal, tax, and total
...
/*--- Parse the items field which may be stringified JSON ----*/
...
// Helper function to upload files to public
...
export async function updateInvoice(req, res) {
    ...
    // If invoiceNumber is being changed, ensure no conflict
